...
public class MyFirstProgram {
    ...
    public static void main(String[] args) {
       ...
       // Функция
       System.out.println("Function: Расстояние от точки до точки равно: " + distance(p1,p2));

        System.out.println("Method: Расстояние от точки до точки равно: " + p2.countDistance(p1));
