...
public class TestBase {
    ...
    /*
    protected boolean blockAdditionalInformation() {
        return true;
    }
    */

    protected void blockAdditionalInformation(String addInformation) {
        driver.findElement(By.name("additional_info")).click();
        driver.findElement(By.name("additional_info")).clear();
        driver.findElement(By.name("additional_info")).sendKeys(addInformation);
